...
#define UART_RECEVIER_UART_INDEX            UART_6              // 定义串口接收机使用的串口
#define UART_RECEVIER_TX_PIN                UART6_TX_P03_1    // 遥控器接收机没有这个引脚，仅用于串口初始化时占位使用
#define UART_RECEVIER_RX_PIN                UART6_RX_P03_0      // 串口接收机的TX引脚 连接单片机的RX引脚
