...
{ 
    ...
    // wireless_uart_send_string(",");
    // wireless_uart_send_decimal(uart_receiver.channel[0]);
    // wireless_uart_send_string(",");
    // wireless_uart_send_decimal(uart_receiver.channel[1]);
    // wireless_uart_send_string(",");
    // wireless_uart_send_decimal(uart_receiver.channel[2]);
    // wireless_uart_send_string(",");
    // wireless_uart_send_decimal(uart_receiver.channel[3]);
    // wireless_uart_send_string(",");
    // wireless_uart_send_decimal(uart_receiver.channel[4]);
    // wireless_uart_send_string(",");
