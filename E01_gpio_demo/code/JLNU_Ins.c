...
void INS_CalibrateAccelerometer(void) {
    ...
    printf("校准结果: offset_x=%.3f, offset_y=%.3f, offset_z=%.3f\n",
...
void INS_Update(void) {
    ...
    /* 定义常量 */
    #define GRAVITY_M_S2 9.80485f      /* 标准重力加速度 m/s^2 */
    #define G_TO_MS2 9.80485f          /* g到m/s^2的转换系数 */
    #define MOTION_THRESHOLD 0.15f     /* 运动阈值 m/s^2 */
